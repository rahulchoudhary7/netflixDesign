        ...
        <ReactPlayer
          ...
          <div className="absolute bottom-10 flex w-full items-center justify-between px-10">
            <div className="flex space-x-2">
                <button className="flex items-center gap-x-2 rounded bg-white px-8 text-xl font-bold text-[#181818] transition hover:bg-[#e6e6e6]">
                    <FaPlay className="h-7 w-7 text-[#181818]"/>
                    Play
                </button>
